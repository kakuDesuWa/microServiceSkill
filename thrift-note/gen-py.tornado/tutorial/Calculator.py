...
class Processor(shared.SharedService.Processor, Iface, TProcessor):
    ...
    def process_add(self, seqid, iprot, oprot):
        ...
        msg_type = TMessageType.REPLY
        try:
            result.success = yield gen.maybe_future(self._handler.add(args.num1, args.num2))
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            logging.exception('TApplication exception in handler')
    ...
    def process_calculate(self, seqid, iprot, oprot):
        ...
        msg_type = TMessageType.REPLY
        try:
            result.success = yield gen.maybe_future(self._handler.calculate(args.logid, args.w))
    ...
    def process_zip(self, seqid, iprot, oprot):
        ...
        iprot.readMessageEnd()
        try:
            yield gen.maybe_future(self._handler.zip())
        except TTransport.TTransportException:
            raise
        except Exception:
